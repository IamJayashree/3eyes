                        ...
                        <div className="col-lg-8">
                            <div className="card-body p-4 p-md-5">
                                <div className="row g-3">
                                    ...
                                    <div className="col-md-12">
                                        <Form.Group size="lg" controlId="volunteerGender">
                                            <Form.Label className="form-label mb-0">Volunteer Gender</Form.Label>
                                            <div className="my-3">
                                                <div className="form-check-inline">
                                                    <Form.Label className="form-check-label">Male</Form.Label>
                                                ...
                                                <div className="form-check-inline">
                                                    <Form.Label className="form-check-label">Female</Form.Label>
                                                    <Form.Control className="form-check-input"
                                                        autoFocus
                                                        type="radio"
                                                        name="female" />
