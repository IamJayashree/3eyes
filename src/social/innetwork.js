                    ...
                    <Accordion defaultActiveKey="0">
                            ...
                            <Accordion.Body>
                                <div className="row g-0">
                                    <div className="col-auto">
                                        <img className="img-thumbnail me-3 img-fluid rounded-circle shadow-sm" src={a01[0]} width="64" height="64" alt="" />
                                    </div>
                                ...
                                <div className="row g-0">
                                    <div className="col-auto">
                                        <img className="img-thumbnail me-3 img-fluid rounded-circle shadow-sm" src={a02[0]} width="64" height="64" alt="" />
                                    </div>
                                    <div className="col">
                                        <h6 className="mb-0">
                                            {a02[2]}
                        ...
                        <Accordion.Item eventKey="1">
                            ...
                            <Accordion.Body>
                                <div className="row g-0">
                                    <div className="col-auto">
                                        <img className="img-thumbnail me-3 img-fluid rounded-circle shadow-sm" src={a03[0]} width="64" height="64" alt="" />
                                    </div>
                                    <div className="col mb-3 pb-3 border-bottom">
                                        <h6 className="mb-0">
                                            {a03[1]}
                                ...
                                <div className="row g-0">
                                    <div className="col-auto">
                                        <img className="img-thumbnail me-3 img-fluid rounded-circle shadow-sm" src={a04[0]} width="64" height="64" alt="" />
                                    </div>
                                    <div className="col">
                                        <h6 className="mb-0">
                                            {a04[1]}
                        ...
                        <Accordion.Item eventKey="2">
                            ...
                            <Accordion.Body>
                                <div className="row g-0">
                                    <div className="col-auto">
                                        <img className="img-thumbnail me-3 img-fluid rounded-circle shadow-sm" src={a05[0]} width="64" height="64" alt="" />
                                    </div>
                                    <div className="col mb-3 pb-3 border-bottom">
                                        <h6 className="mb-0">
                                            {a05[1]}
                                ...
                                <div className="row g-0">
                                    <div className="col-auto">
                                        <img className="img-thumbnail me-3 img-fluid rounded-circle shadow-sm" src={a06[0]} width="64" height="64" alt="" />
                                    </div>
                                    <div className="col">
                                        <h6 className="mb-0">
                                            {a06[1]}
                        ...
                        <Accordion.Item eventKey="3">
                            ...
                            <Accordion.Body>
                                <div className="row g-0">
                                    <div className="col-auto">
                                        <img className="img-thumbnail me-3 img-fluid rounded-circle shadow-sm" src={a07[0]} width="64" height="64" alt="" />
                                    </div>
                                    <div className="col mb-3 pb-3 border-bottom">
                                        <h6 className="mb-0">
                                            {a07[1]}
